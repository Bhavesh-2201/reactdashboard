    ...
    <div className="bg-black h-16 px-4 flex justify-between items-center border-b border-gray-200">
      <div className="relative">
        ...
        <input
          type="text"
          placeholder="Search... "
          className="text-sm focus:outline-none active:outline-none h-10 w-[24rem] border-gray-300 rounded-sm pl-11 px-4"
        ></input>
      </div>
      <div className="flex items-center gap-2 mr-2">
        ...
        <Menu as="div" className="relative">
          <Menu.Button className="bg-teal-500 ml-2 inline-flex rounded-full focus:outline-none focus:ring-2 focus:ring-neutral-400">
